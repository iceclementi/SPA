...
namespace DesignExtractor {
	...
	//Iteration 3 code
	//bool DesignExtractor::extractAffects(STMT_NUM a1, STMT_NUM a2) {
	//	bool result;
	//	VAR_NAMES var_modified = pkb.getVarModifiedInStmt(a1);
	//	PROG_LINES next_stmts = pkb.getNextOf(DESIGN_ENTITY::PROG_LINE, a1);
	//	// both statements are in same procedure 
	//	for (auto f : next_stmts) {
	//		result = CGFTraversal(a1, f, a2, var_modified);
	//		if (result == true) {
	//			return result;
	//		}
	//	}
