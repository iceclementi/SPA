...
public:
	...
	/* Returns the boolean for one of Relationship (firstValue, secondValue), 
	Relationship (firstValue, _), Relationship (_, secondValue) or Relationship (_, _) */
	...
	/* Returns the set of assign statement numbers a for one of a ("varName", "x") or a (_, "x") 
	or a ("varName", _"x"_) or a (_, _"x"_) */
	...
	/* Returns the set of pairs of statement numbers (read, print, call) with matching vars */
	VALUE_PAIRS getStmtVarPairsOf(DESIGN_ENTITY firstStmtType, DESIGN_ENTITY secondStmtType, 
		VALUES& tableValuePairs, bool isFirstValues);
	/* Returns the set of pairs of statement numbers (read, print, call) with matching vars */
	VALUE_PAIRS getStmtVarPairsOf(DESIGN_ENTITY firstStmtType, DESIGN_ENTITY secondStmtType);
	...
	/* Returns the set of pairs of statement numbers (read, print, call) that matches the vars (procedures, variables) */
	VALUE_PAIRS getStmtVarVarPairsOf(DESIGN_ENTITY stmtType, DESIGN_ENTITY varType, 
		VALUES& tableValuePairs, bool isStmtValues);
	/* Returns the set of pairs of statement numbers (read, print, call) that matches the vars (procedures, variables) */
	VALUE_PAIRS getStmtVarVarPairsOf(DESIGN_ENTITY stmtType, DESIGN_ENTITY varType);
...
struct PKBMain {
	RelationshipStorage<INDEX, INDEX> fStore, fStarStore, pStore, pStarStore, 
		uStmtStore, uProcStore, mStmtStore, mProcStore, cStore, cStarStore, nStore;
