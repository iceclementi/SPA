...
void SuchThatClauseEvaluator::init() {
    ...
    case SUCH_THAT_REL_TYPE::NEXTBIP:
        relType = RELATIONSHIP_TYPE::NEXT_BIP;
        break;
    case SUCH_THAT_REL_TYPE::NEXTBIP_T:
        relType = RELATIONSHIP_TYPE::NEXT_BIP_STAR;
        canHaveRelationshipToSelf = true;
        break;
    case SUCH_THAT_REL_TYPE::AFFECTSBIP:
        relType = RELATIONSHIP_TYPE::AFFECTS_BIP;
        canHaveRelationshipToSelf = true;
        break;
    case SUCH_THAT_REL_TYPE::AFFECTSBIP_T:
        relType = RELATIONSHIP_TYPE::AFFECTS_BIP_STAR;
        canHaveRelationshipToSelf = true;
        break;
    default:
        return;
